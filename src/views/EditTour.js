  ...
  return (
    <div className='AddEditTours'>
      <div className='container'>
        ...
        <label>Summary</label>
        <textarea
          className='AddEdit-description AddEdit-input'
          value={tourSummary}
      ...
      <div className='container'>
        ...
        <input
          className='duration-price__input'
          type='text'
          value={tourDuration}
        ...
        />
        <button type='button' className='AddEdit-btn' onClick={onClick}>
          Save
        </button>
      </div>
    </div>
