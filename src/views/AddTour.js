      ...
      try {
        const response = await axios.post(
          'https://layag-travel-tours-be.herokuapp.com/api/v1/tours',
          {
            ...
            imageCover: previewImageCover[0],
            locations,
            startLocation,
            images: previewImage,
            tags,
  ...
  return (
    <>
      <div className='AddTours'>
            ...
            <div className='Add-details__inputs'>
              ...
              <div>
                ...
                <input
                  type='number'
                  placeholder='(e.g 10)'
                  value={tourMaxGroupSize}
                  onChange={(e) => setTourMaxGroupSize(e.target.value)}
                />
              </div>
              <div>
                <label>Price</label>
          ...
          <div className='Add-images container'>
                ...
                ? previewImage.map((file, i) => {
                    ...
                    return (
                      <li key={keyAlt} className='image-list'>
                        <img src={img} className='per-image' alt={keyAlt} />
                        <button
                          type='button'
            ...
            <div className='Add-images__btns'>
              ...
              <div className='Add-images-btns'>
                <button onClick={(e) => setHidden('startLocation')}>
                  Start Location +
                </button>
                <button onClick={(e) => setHidden('location')}>
                  Locations +
                </button>
                <button onClick={(e) => setHidden('tags')}>Tags +</button>
                <button onClick={(e) => setHidden('tourGuide')}>
                  Tour guide +
                </button>
              </div>
            </div>
        ...
        <button className='AddEdit-btnSave' onClick={addTourFunction}>
          {' '}
          Save{' '}
        </button>
      </div>
        ...
        <div className='AddModal'>
          <div className='AddModal-startLocation'>
            ...
            <div>
              ...
              <input
                type='text'
                placeholder='(e.g Laguna Calamba)'
                value={address}
        ...
        <div className='AddModal'>
          <div className='AddModal-locations'>
            ...
            <div>
              ...
              <input
                type='text'
                placeholder='(e.g Island Nowhere )'
                value={locDescription}
                onChange={(e) => setLocDescription(e.target.value)}
              />
              <label>Days</label>
              ...
              <button onClick={(e) => setHidden('')}> Cancel </button>
              <button className='btn-addLocation' onClick={addLocation}>
                {' '}
                Add Location +
              </button>
            </div>
        ...
        <div className='AddModal'>
          <div className='AddModal-tags'>
            ...
            <div>
              ...
              <button onClick={(e) => setHidden('')}> Cancel </button>
              <button className='btn-addTags' onClick={addTags}>
                {' '}
                Add Tags +
              </button>
            </div>
        ...
        <div className='AddModal'>
          <div className='AddModal-tour-guide'>
            ...
            <div>
              ...
              <input
                type='text'
                placeholder='(e.g 62de950502bb955156e1ca69)'
                value={tourGuide}
              ...
              <button onClick={(e) => setHidden('')}> Cancel </button>
              <button className='btn-addTourGuide' onClick={addTourGuide}>
                {' '}
                Add Tour guide +
              </button>
            </div>
